...
export default function Navigate() {
    ...
    return (
        ...
        <nav className="bg-background text-black w-[90%] mx-auto mt-10 py-4 px-8 rounded-full flex items-center justify-between overflow-hidden font-primary text-xl relative z-[100]">
            ...
            <div className="flex items-center gap-16 min-w-0 flex-nowrap overflow-hidden">
                ...
                <ul className="hidden md:flex gap-[clamp(1rem,2vw,4rem)] items-center flex-nowrap min-w-0 overflow-hidden text-nowrap">
                    ...
                    <li><a href="/sponsors" className="hover:text-primary transition">Sponsors</a></li>
        ...
        <div className="fixed inset-0 z-40 bg-foreground text-white md:hidden flex flex-col items-center justify-center space-y-6 pt-30 gap-10">
            ...
            <a href="/faqs" onClick={() => setMenuOpen(false)} className="hover:text-red-500 text-xl">FAQs</a>
            <a href="/team" onClick={() => setMenuOpen(false)} className="hover:text-red-500 text-xl">Team</a>
            ...
            <div className="flex space-x-6 items-center">
                ...
                <a href="https://www.linkedin.com/company/formulatech-hacks" className="hover:text-primary">
                    <img src={linkedin.src} alt="LinkedIn" className="h-10 w-10 object-contain filter brightness-0 invert" />
                </a>
                <a href="mailto:someone@example.com" className="hover:text-primary">
                    <img src={email.src} alt="Email" className="h-20 w-20 object-contain filter brightness-0 invert" />
                </a>
            </div>
        </div>
        )
