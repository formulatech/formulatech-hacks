		...
		<>
				...
				<div className="flex items-center gap-[clamp(0.5rem,1vw,1.5rem)] flex-nowrap min-w-0 overflow-hidden">
					...
					<div className="hidden md:flex items-center gap-[clamp(0.5rem,1vw,1.5rem)] min-w-0">
						<a
							...
							className="hover:text-primary fill-primary"
						>
							<img
								src={instagram.src}
								alt="Instagram"
								className="h-15 w-15 object-cover fill-current"
							/>
						</a>
						<a
							href="https://www.linkedin.com/company/formulatech-hacks"
							className="hover:text-primary"
						>
							<img
								src={linkedin.src}
								alt="LinkedIn"
								className="h-7 w-7 object-cover fill-current"
							/>
						</a>
						...
						<div className="ml-4 flex items-center space-x-4">
							<a
								href="/register"
								className="bg-primary text-white font-bold px-4 py-2 rounded-2xl hover:opacity-90 transition"
							>
								REGISTER
							</a>
							<a
								href="/login"
								className="border-2 border-primary text-primary font-bold px-4 py-2 rounded-2xl hover:bg-white transition"
							>
								LOGIN
							</a>
						</div>
			...
			<div className="fixed inset-0 z-40 bg-foreground text-white md:hidden flex flex-col items-center justify-center space-y-6 pt-30 gap-10">
				...
				<div className="flex flex-col items-center space-y-4">
					<a
						href="/register"
						className="bg-primary text-white font-bold px-6 py-3 w-40 rounded-2xl hover:opacity-90 transition text-center"
					>
						REGISTER
					</a>
					<a
						href="/login"
						className="border-2 border-primary text-primary font-bold px-6 py-3 w-40 rounded-2xl hover:bg-[#fff] transition text-center"
					>
						LOGIN
					</a>
				</div>
