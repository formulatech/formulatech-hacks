...
export default function Countdown () {
    ...
    return (
        ...
        <div className="h-[500px] w-8/10 p-3 bg-[#1C1B20] r-2 flex rounded-4xl border-black border-5 justify-evenly">
...
function CountdownColumn ({label, value} : {label : string, value : number}) {
    ...
    return (
        ...
        <div className="w-23/100 h-full flex flex-col justify-evenly">
            <div className="h-3/20 flex w-full bg-[#fefdf3] rounded-lg border-5 border-[#d1283e] justify-center items-center">
                <p className="font-bold font-title text-3xl">{label}</p>
            </div>
            <div className="relative flex h-7/10 w-full bg-yellow-200 rounded-lg border-5 border-[#d1283e] text-[100px]">
...
function Digit({ dig }: { dig: number }) {
    ...
    return (
        <div className="relative flex-col w-1/2 border border-[#d1283e] perspective-[400px]">
            {/* Static top half */}
            <div className="w-full h-1/2 bg-[#fefdf3] relative text-center leading-[3.12]">
                {curNumber}
            </div>
            ...
            {/* Flipping top half */}
            <div 
                className={`absolute overflow-hidden top-0 w-full h-1/2 bg-[#fefdf3] text-center leading-[3.13] origin-bottom ${
